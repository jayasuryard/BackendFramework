  ...
  return JSON.stringify(
    {
      ...
      dependencies: {
        'ryoforge-runtime-framework': '^1.0.0',
      },
    },
    null,
    2
...
const { ${runtime} } = require('ryoforge-runtime-framework');
...
const { lambda } = require('ryoforge-runtime-framework');
...
const fs = require('fs');
const path = require('path');
const { postman } = require('ryoforge-runtime-framework');
